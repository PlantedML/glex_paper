...
RcppExport SEXP _shapdecomp_recurse(SEXP xSEXP, SEXP featureSEXP, SEXP splitSEXP, SEXP yesSEXP, SEXP noSEXP, SEXP qualitySEXP, SEXP coverSEXP, SEXP USEXP, SEXP nodeSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _shapdecomp_contribute(SEXP matSEXP, SEXP m_allSEXP, SEXP SSEXP, SEXP TSEXP, SEXP T_subsetsSEXP, SEXP colnumSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_shapdecomp_recurse", (DL_FUNC) &_shapdecomp_recurse, 9},
    {"_shapdecomp_contribute", (DL_FUNC) &_shapdecomp_contribute, 6},
    {NULL, NULL, 0}
};

RcppExport void R_init_shapdecomp(DllInfo *dll) {
